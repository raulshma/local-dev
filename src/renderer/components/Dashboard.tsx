...
const Dashboard: React.FC = () => {
  ...
  const [dockerConfigurations, setDockerConfigurations] = useState<
    Map<string, boolean>
  >(new Map());
  ...
  const getProjectScriptStatus = (projectId: string) => {
    const runningProjectScripts = Array.from(runningScripts).filter(
      (scriptKey) => scriptKey.startsWith(`${projectId}:`),
    );
                  ...
                  <div className="project-details">
                      ...
                      <div className="project-meta">
                        ...
                        {selectedProject.lastAccessed && (
                          <div className="meta-item">
                            <span>🕒</span>
                            Last accessed:{' '}
                            {formatDate(selectedProject.lastAccessed)} at{' '}
                            {formatTime(selectedProject.lastAccessed)}
                          </div>
                        )}
                      </div>
                    </div>{' '}
                        ...
                        <div className="action-grid">
                          ...
                          >
                            ...
                            <div className="action-card-content">
                              ...
                              <div className="action-card-description">
                                Launch your preferred IDE with this project
                              </div>
                            </div>
                          </button>
                          <button
                          ...
                          >
                            ...
                            <div className="action-card-content">
                              ...
                              <div className="action-card-description">
                                Auto-detect and run the development server
                              </div>
                            </div>
                          </button>
                        </div>
                          ...
                          <>
                            ...
                            <div className="action-grid">
                              <button
                                ...
                                onClick={async () => {
                                  try {
                                    await window.electron.docker.executeScript(
                                      selectedProject.id,
                                      'build',
                                    );
                                  } catch (err) {
                    ...
                    {activeTab === 'scripts' && (
                      <ScriptsTab
                        ...
                        onAddScript={(script) =>
                          addScript(selectedProject.id, script)
                        }
                        onRemoveScript={(scriptId) =>
                          removeScript(selectedProject.id, scriptId)
                        }
                        onUpdateScript={(script) =>
                          updateScript(selectedProject.id, script)
                        }
                        onExecuteScript={(scriptId) =>
                          executeScript(selectedProject.id, scriptId)
                        }
                        onStopScript={(scriptId) =>
                          stopScript(selectedProject.id, scriptId)
                        }
                      />
                    )}{' '}
              ...
              <div className="editor-content">
                ...
                <div className="empty-state">
                  ...
                  <div className="empty-state-title">
                    Welcome to Local Dev Environment
                  </div>
                  <div className="empty-state-description">
                    Select a project from the sidebar to view its details and
